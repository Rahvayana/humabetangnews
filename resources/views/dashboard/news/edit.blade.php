          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <form id="form-update" class="form-horizontal" action="{{ URL('dashboard/news/update/'.$news->id) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="col-sm-12">
                                ...
                                <input class="form-control" id="name" name="title" type="text" value="{{$news->news_title}}" placeholder="Title news">
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="select1" name="category_id" value="{{$news->category_id}}}">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input class="form-control" id="name" name="video_url" value="{{$news->news_video}}" type="text" placeholder="ex: https://www.youtube.com/watch?v=LmvQgMlRMwc">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <div class="col-md-9 col-form-label">
                                ...
                                <input class="form-check-input" id="check1" type="checkbox" name="is_slideshow" {{ $news->news_status_slideshow ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                              <label class="form-label" for="textarea-input">Date Time Published</label> 
                                  <div class='input-group date'>
                                      ...
                                      <input required id='datetimepicker1' value="{{$news->news_publish_datetime}}" type='text' placeholder="Input date time" name="datetime_published" class="form-control datetimepicker" readOnly/>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                  ...
                                  <textarea class="form-control" name="content" id="editor1" style="width:100%" rows="10">{!! $news->news_content !!}</textarea>
