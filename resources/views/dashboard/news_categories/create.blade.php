      ...
      <div class="container-fluid">
        <div class="animated fadeIn">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">Add News Category</div>

                <form id="needs-validation" class="form-horizontal" action="{{ URL('dashboard/news-category/store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
