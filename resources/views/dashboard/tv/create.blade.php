      ...
      <div class="container-fluid">
        <div class="animated fadeIn">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">Add Tv</div>

                <form id="form-update" class="form-horizontal" action="{{ URL('dashboard/tv/store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                              ...
                              <input class="form-control" id="name" name="tv_name"  type="text" placeholder="Tv name">
                              </div>
                          </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  ...
                                  <input class="form-control" id="name"  name="tv_url_stream" type="text" placeholder="">
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                    <input id="file-inputapp" type="file" name="tv_img" >
                                    </div>
                                </div>
                            </div>
                            </div>
                          ...
                          <div class="card">
                              ...
                              <textarea name="tv_description"  style="width:100%" rows="10"></textarea>
                              </div>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a type="button" href="{{url('/dashboard/tv')}}" class="btn btn-sm btn-danger">
