<div class="sidebar">
    <nav class="sidebar-nav">
      <ul class="nav">
            ...
            <li class="nav-item mt-2 {{ $dashboard }}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/news')}}">
            <i class="nav-icon icon-list"></i> All News</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/news-category')}}">
            <i class="nav-icon icon-pencil"></i> Category News</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/slideshow')}}">
            <i class="nav-icon icon-puzzle"></i> SlideShow</a>
        </li>


        <li class="nav-title">Tv Streaming</li>

        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/tv')}}">
            <i class="nav-icon icon-list"></i> Tv List</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/users')}}">
            <i class="nav-icon icon-list"></i> All Users</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/admin')}}">
            <i class="nav-icon icon-list"></i> Administrator</a>
        </li>


        <li class="nav-title">Advertisement</li>

        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/ads')}}">
            <i class="nav-icon icon-list"></i> Ads list</a>
        </li>

        <li class="nav-title">Notification</li>

        <li class="nav-item">
          <a class="nav-link" href="{{url('/dashboard/notification')}}">
            <i class="nav-icon icon-list"></i> Send Notification</a>
        </li>
